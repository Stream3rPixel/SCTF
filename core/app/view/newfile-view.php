...
<div class="row">
  ...
  <div class="form-group">
    <label for="XD" class="col-lg-2 control-label">Titulo*</label>
    <div class="col-md-6">
  ...
  <div class="form-group">
    <label for="XD" class="col-lg-2 control-label">Archivo*</label>
    <div class="col-md-6">
  ...
  <div class="form-group">
    <label for="XD" class="col-lg-2 control-label">Tipo*</label>
    <div class="col-md-6">
  ...
  <div class="form-group">
    <label for="XD" class="col-lg-2 control-label">Descripcion*</label>
    <div class="col-md-6">
