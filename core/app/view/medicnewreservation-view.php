...
<option value="">-- Seleccionar --</option>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-5">
      <input type="date" name="date_at" id="date_at" required class="pickadate2 form-control" id="XD" placeholder="Fecha">
    </div>
    <div class="col-lg-5">
      <!-- <input type="time" name="time_at" id="time_at" required class="pickatime form-control" id="XD" placeholder="Hora"> -->
<select name="time_at" id="time_at" required class="form-control">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
    <textarea class="form-control" name="sick" placeholder="Diagnóstico"></textarea>
    </div>
  </div>
      <div class="form-group">
