...
<form class="form-horizontal" role="form" id="newquickreservationform">
  <div class="form-group">
    ...
    <div class="col-lg-10">
      <input type="text" name="title" id="title" required class="form-control" id="XD" placeholder="Servicio">
    </div>
  </div>
  <div class="form-group">
...
<option value="">-- Seleccionar --</option>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-5">
      <input type="text" name="date_at" id="date_at" required class="pickadate form-control" id="XD" placeholder="Fecha">
    </div>
    <div class="col-lg-5">
      <input type="text" name="time_at" id="time_at" required class="pickatime form-control" id="XD" placeholder="Hora">
    </div>
  </div>
    <div class="form-group">
